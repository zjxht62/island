 ...
 * @date 2020/2/29
 */
public class S02E06Observer implements Observer, SendNotification {
    private static final Logger logger = Logger.getLogger(S02E06Observer.class);
    private ResourceData resourceData;
    private float temperature;
    private float humidity;

    public S02E06Observer(ResourceData resourceData) {
    ...
    public void update(Map<String, ResourceInfoModel> resourceInfoModelMap) {
        ...
        ResourceInfoModel s02e01Model = resourceInfoModelMap.get("S02E06");
