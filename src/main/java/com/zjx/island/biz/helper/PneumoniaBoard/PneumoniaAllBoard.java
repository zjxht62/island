 ...
 * @date 2020/1/22
 */
public class PneumoniaAllBoard implements Observer, BaseBoard {

    public PneumoniaAllBoard(Observable observable) {
    ...
    public void update(Observable o, Object arg) {
        if (o instanceof PneumoniaData) {
            ...
            stringBuilder.append(pneumoniaData.getAllStatus());
